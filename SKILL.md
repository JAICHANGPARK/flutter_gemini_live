...
This skill guides AI agents (Antigravity, Cursor, Windsurf, Claude Code, GitHub Copilot, etc.) in using the `gemini_live` Flutter package to build real-time, low-latency, multimodal applications connected directly to Google's Gemini Live API via WebSockets.
